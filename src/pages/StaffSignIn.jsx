      ...
      <div className="flex items-center justify-center min-h-screen bg-black bg-opacity-50">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-2">
           ...
           <Link to="/ChangeStaffPass" className="text-amber-600 font-semibold hover:underline text-sm">
                Forgot Password?
              </Link>
          </div>
          <button
          ...
          <div className="text-center">
            <p className="text-sm text-gray-300">
              Are You a New Staff ?{" "}
              <Link to="/StaffReg" className="text-amber-600 font-semibold hover:underline">
                Create account.
              </Link>
            </p>
          </div>
